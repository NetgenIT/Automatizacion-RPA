...
archivo1 = ("/srv/salt/files_txt/Parchado_Minion"+cliente+"1.txt")
archivo2 = ("/srv/salt/files_txt/Status_Parchado"+cliente+"1.txt")
archivo3 = ("/srv/salt/"+ cliente +"1.txt")
archivo4 = ("/srv/salt/files_txt/"+cliente+"comando1.txt")
archivo5 = ("/srv/salt/files_txt/"+cliente+"comando12.txt")
...
def Lectura():
    ...
    os.system ("salt 'NGIT-AUT-001' cmd.run 'cat /srv/salt/"+ cliente +"1.txt'"+">/srv/salt/files_txt/Parchado_Minion"+ cliente +"1.txt")
