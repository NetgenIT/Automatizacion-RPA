...
def Lectura():
    ...
    os.system ("salt 'NGITQA-AUT-001' cmd.run 'cat /srv/salt/"+ cliente +"1.txt'"+">/srv/salt/files_txt/Parchado_Minion"+ cliente +"1.txt")
...
def correo():
    ...
    destinatario =['walterio.mendez@tivit.com','demian.rivas@tivit.com','claudio.gonzalez@tivit.com']
