...
def Lectura():
    ...
    try:
        os.system ("salt 'NGIT-AUT-001' cmd.run 'cat /srv/salt/"+ cliente +".txt'"+">/srv/salt/files_txt/Lista_Servidores_Parchados_Cliente_"+ cliente +".txt")
        os.system ("salt 'NGIT-AUT-001' cmd.run 'cat /srv/salt/"+ cliente +".txt'"+">/srv/salt/files_txt/Informe"+ cliente +".txt")
...
def limpia():
    ...
    try:
        ...
        subprocess.call(['sed','-i','/.*NGIT-AUT-001:*/d',archivo6])
